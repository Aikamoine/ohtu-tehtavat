...
public class Stepdefs {
    ...
    @When("uninitialised username {string} and existing password {string} are given")
    public void uninitialisedUsernameAndExistingPasswordAreGiven(String username, String password) {
        logInWith(username, password);
    }
